...
- private Rebuy Clue Rescue on the dashboard that derives a queue of `again`/`maybe` cards missing purchase place, price, purchase link, or rebuy reason, so users can reopen the card or start the next quick record before that bean becomes hard to buy again;
