...
test("CoffeeDex package identity exposes the real app stack", () => {
  ...
  assert.equal(
    ...
    "node --test test/profile-route.test.mjs test/export-route.test.mjs test/account-route.test.mjs test/admin-route.test.mjs test/analytics-ownership-route.test.mjs test/checkout-api-contract.test.mjs test/pdf-route.test.mjs test/credit-lifecycle.test.mjs test/scan-trust.test.mjs test/cards-create-contract.test.mjs test/memory-crud-contract.test.mjs test/shelf-consumption.test.mjs test/brewing-logs-route.test.mjs test/dial-in-coach-route.test.mjs test/rebuy-intelligence-route.test.mjs test/rebuy-calendar-funnel.test.mjs test/rebuy-calendar-route.test.mjs test/rebuy-calendar-return-route.test.mjs test/stripe-webhook-idempotency.test.mjs test/subscription-lifecycle.test.mjs",
  );
  assert.equal(
