...
export function DashboardRebuyIntelligencePanel({
  ...
  if (isLoading) {
    return (
      <section className="rounded-[1.75rem] border border-white/10 bg-[#120d09] p-5 text-[#F7F7F4]" aria-label="Rebuy Intelligence">
  ...
  return (
    <section className="rounded-[1.75rem] border border-primary-amber/20 bg-[#120d09] p-4 text-[#F7F7F4] shadow-[0_24px_80px_rgba(0,0,0,0.28)] sm:p-5" aria-label="Rebuy Intelligence">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.035] px-4 py-3">
          ...
          <p className="mt-1 text-sm font-black text-[#F7F7F4]">{topScore.roi}점 · {topScore.reason}</p>
        </div>
      </div>
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <button
          ...
          className="min-w-0 rounded-2xl border border-white/10 bg-white/[0.04] p-4 text-left transition hover:border-primary-amber/35"
        >
          ...
          <p className="mt-1 truncate text-xs font-semibold text-[#F7F7F4]/45">{data.rebuyReminder.subtitle}</p>
          <p className="mt-3 break-keep text-sm font-semibold leading-6 text-[#F7F7F4]/62">{data.rebuyReminder.reason}</p>
        ...
        >
          ...
          <p className="mt-1 truncate text-xs font-semibold text-[#F7F7F4]/45">{data.tasteMatch.anchorTitle}</p>
          <p className="mt-3 break-keep text-sm font-semibold leading-6 text-[#F7F7F4]/62">{data.tasteMatch.reason}</p>
        ...
        >
          ...
          <p className="mt-1 truncate text-xs font-semibold text-[#F7F7F4]/45">{data.purchaseMemory.subtitle}</p>
          <p className="mt-3 break-keep text-sm font-semibold leading-6 text-[#F7F7F4]/62">{data.purchaseMemory.reason}</p>
        ...
        >
          ...
          <p className="mt-1 truncate text-xs font-semibold text-[#F7F7F4]/45">{data.brewFailureMemory.subtitle}</p>
          <p className="mt-3 break-keep text-sm font-semibold leading-6 text-[#F7F7F4]/62">{data.brewFailureMemory.adjustment}</p>
          <p className="mt-4 line-clamp-2 text-xs font-semibold text-[#F7F7F4]/45">{data.brewFailureMemory.evidence}</p>
        </button>
      </div>
    </section>
  );
